...
ops.fbinary             = fullfile(dpath, '20150924_1_GT.dat'); % will be created for 'openEphys'		
...
ops.NchanTOT            = 129;           % total number of channels (omit if already in chanMap file)
ops.Nchan               = 129;           % number of active channels (omit if already in chanMap file)
